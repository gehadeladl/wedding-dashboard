...
export default function ShirtsPage() {
  ...
  const getProducts = async () => {
    try {
      const res = await api.get("/website/products?section=SHIRTS");
  ...
  const getWhatsappLink = (productName) => {
    ...
    const message = `السلام عليكم، أريد الاستفسار عن القميص: ${productName}`;
    ...
    <WebsiteLayout>
      ...
      >
        ...
        >
          ...
          >
            مجموعة متنوعة من القمصان الرسمية والكاجوال بخامات ممتازة وتفاصيل
            أنيقة.
          </p>
        </motion.div>
      </section>
