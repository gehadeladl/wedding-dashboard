...
export default function CasualPage() {
  ...
  const getProducts = async () => {
    try {
      const res = await api.get("/website/products?section=TSHIRTS_PULLOVERS");
    ...
    <WebsiteLayout>
      ...
      >
        ...
        >
          ...
          >
            مجموعة كاجوال عصرية من التيشيرتات والبلوفرات بخامات مريحة وأناقة
            بسيطة.
          </p>
        </motion.div>
      </section>
