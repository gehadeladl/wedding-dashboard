/*
  ...
  - You are about to drop the column `shirtType` on the `CustomerMeasurement` table. All the data in the column will be lost.
  - You are about to drop the column `shoesType` on the `CustomerMeasurement` table. All the data in the column will be lost.
...
INSERT INTO "new_CustomerMeasurement" ("armhole", "beltColor", "beltEnabled", "beltMaterial", "bouquetEnabled", "bowtieEnabled", "bowtieMaterial", "bowtieSize", "calf", "chest", "circumference", "collarStyle", "customerId", "fabricCategory", "fabricOrigin", "halfHip", "id", "jacketLength", "jacketNotes", "legOpening", "pantsLength", "shirtColor", "shirtEnabled", "shoesMaterial", "sleeveLength", "socksColor", "socksEnabled", "stomach", "thigh", "tieEnabled", "tieNotes", "tiePocketSquare", "vestButtons", "vestCollar", "vestEnabled", "waist", "wideBeltColor", "wideBeltEnabled", "wideBeltMaterial", "zipper") SELECT "armhole", "beltColor", "beltEnabled", "beltMaterial", "bouquetEnabled", "bowtieEnabled", "bowtieMaterial", "bowtieSize", "calf", "chest", "circumference", "collarStyle", "customerId", "fabricCategory", "fabricOrigin", "halfHip", "id", "jacketLength", "jacketNotes", "legOpening", "pantsLength", "shirtColor", "shirtEnabled", "shoesMaterial", "sleeveLength", "socksColor", "socksEnabled", "stomach", "thigh", "tieEnabled", "tieNotes", "tiePocketSquare", "vestButtons", "vestCollar", "vestEnabled", "waist", "wideBeltColor", "wideBeltEnabled", "wideBeltMaterial", "zipper" FROM "CustomerMeasurement";
